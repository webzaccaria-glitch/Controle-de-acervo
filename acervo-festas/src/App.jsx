          ...
          <div>
            ...
            <div className="form-grid" style={{marginBottom:16}}>
              ...
              <div>
                ...
                <input value={form.icon} onChange={e=>setF('icon',e.target.value)} placeholder="🎁" style={{fontSize:20,textAlign:'center'}} maxLength={4}/>
              </div>
            </div>
            <div style={{marginBottom:20}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:8,marginTop:8}}>
                {COLOR_PRESETS.map(p=>(
                  <div key={p.name} onClick={()=>setForm(f=>({...f,bg:p.bg,accent:p.accent}))}
