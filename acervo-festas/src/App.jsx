...
function InventoryTab({inventory,rentals,subcategories,onAdd,onUpdate,onDelete,onAddSubcat,onDeleteSubcat}) {
  ...
  const selectedCat = CATS.find(c=>c.key===viewCat)
  ...
  if (viewCat===null) return (
    <div>
      ...
      <div style={{fontFamily:"'Playfair Display',serif",fontSize:16,color:'#d4a843',marginBottom:16}}>Selecione uma categoria para gerenciar</div>
      ...
      {/* Item form modal */}
      {showForm&&<ItemFormModal form={form} set={set} editing={editing} saving={saving} subcategories={subcategories} onSave={handleSave} onClose={close}/>}
    </div>
  )
...
function ItemFormModal({form,set,editing,saving,subcategories,onSave,onClose}) {
  return(
